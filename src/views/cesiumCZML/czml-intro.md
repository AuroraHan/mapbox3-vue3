...
[
  ...
  },
  {
    ...
    "position": {
      ...
      "epoch": "2024-01-01T00:00:00Z",
      "cartesian": [
        0, -6788.728e3, 272.385e3, -164.051e3,
        60, -6783.467e3, 890.457e3, -376.575e3,
        120, -6597.629e3, 1496.847e3, -582.865e3
      ]
    },
    "point": {
      "pixelSize": 10,
...
[
  ...
  },
  {
    ...
    "position": {
      ...
      "cartographicDegrees": [
        0,    116.391, 39.906, 0,
        300,  116.401, 39.916, 0,
        600,  116.411, 39.926, 0,
        900,  116.421, 39.936, 0,
        1200, 116.431, 39.946, 0
      ]
    },
    "orientation": {
      "velocityReference": "#position"
...
[
  ...
  },
  {
    ...
    "name": "塔楼 A",
    "position": {
      "cartographicDegrees": [116.39, 39.90, 0]
    },
    "box": {
      "dimensions": {
        "cartesian": [50, 50, 200]
  ...
  },
  {
    ...
    "name": "塔楼 B",
    "position": {
      "cartographicDegrees": [116.395, 39.90, 0]
    },
    "cylinder": {
      "length": 150,
      "topRadius": 30,
...
[
  ...
  },
  {
    ...
    "name": "车辆 2",
    "position": {
      "cartographicDegrees": [116.40, 39.91, 0]
    },
    "point": {
      "pixelSize": 10,
      "color": "BLUE"
  ...
  "polygon": {
    "hierarchy": {
      ...
      "holes": [
        {
          "positions": {
            "cartographicDegrees": [116.2, 39.2, 0, 116.8, 39.2, 0, 116.8, 39.8, 0, 116.2, 39.8, 0]
          }
        }
      ]
    }
...
const czml = [
  ...
  { "id": "point1", "position": { "cartographicDegrees": [116.39, 39.9, 0] }, "point": { "pixelSize": 10, "color": "RED" } }
]
...
// 方式2：从 URL 加载
const remoteDataSource = await CzmlDataSource.load('https://example.com/data.czml')
