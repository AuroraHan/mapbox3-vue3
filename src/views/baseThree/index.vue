...
const init = () => {
    ...
    const map = textureLoader.load('/images/smoke1.png');
    ...
    // const fireNodeMaterial = new THREE.SpriteMaterial();
    ...
    // const indirectAttribute = new THREE.BufferAttribute(uint32, 5);
