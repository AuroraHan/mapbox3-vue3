...
export class MyPrimitive {
  ...
  createCommand(context: any) {
    ...
    let box = new Cesium.BoxGeometry({
      ...
      maximum: new Cesium.Cartesian3(25000.0, 25000.0, 25000.0),
      minimum: new Cesium.Cartesian3(-25000.0, -25000.0, -25000.0)
    });

    let geometry = Cesium.BoxGeometry.createGeometry(box);

    let attributeLocations = Cesium.GeometryPipeline.createAttributeLocations(geometry)
